...
import static com.company.simple.robot.Direction.*;
import static com.company.simple.robot.Instruction.*;
...
public class Robot {
    ...
    private static RoadBook calculateRoadBook(Direction direction, Coordinates position, Coordinates destination,
